    ...
    renderVideo = () => {
        ...
        >
            <View style={styles.iconContainer}>
                <Image source={require("../assets/R (2).png")} style={{ width: 50, height: 50 }}></Image>
            </View>
        </TouchableOpacity >
    }
//.catch
        ...
        if (Object.keys(this.state.apod).length === 0) {
            ...
            return (
                <View style={styles.container}>
                    ...
                    <ImageBackground source={require('../assets/BBC_News.svg.png')} style={styles.backgroundImage}>
                        ...
                        <ScrollView style={styles.listContainer}>
                            <TouchableOpacity
                                onPress={() => Linking.openURL(this.state.apod.url).catch(err => console.error("Couldn't load page", err))}
                            >
                                <Image source={{ "uri": url }} style={{ width: "100%", height: 200, borderRadius: 10 }}></Image>
                            </TouchableOpacity >
